...
# Contribute to Ory Ory Oathkeeper Maester<!-- omit in toc -->
...
- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/oathkeeper-maester/blob/master/CODE_OF_CONDUCT.md)
...
[list of good first issues](https://github.com/ory/oathkeeper-maester/labels/good%20first%20issue).
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/oathkeeper-maester/blob/master/.github/workflows/conventional_commits.yml)
...
[Contributor License Agreement](https://cla-assistant.io/ory/oathkeeper-maester).
...
git clone git@github.com:ory/ory/oathkeeper-maester.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/oathkeeper-maester.git
